...
/*   Updated: 2025/03/03 16:24:51 by tales            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void compute_wall_bounds(t_game *game, t_player *player, t_ray *ray, t_draw_data *data)
{
    data->dist = fixed_dist(player->x, player->y, ray->x, ray->y, game);
    if (data->dist < 0.1)
        data->dist = 0.1;
...
void compute_draw_data(t_game *game, t_player *player, t_ray *ray, t_draw_data *data)
{
